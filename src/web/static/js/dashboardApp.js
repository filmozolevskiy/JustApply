...
export function bootstrapDashboard() {
  ...
  Object.assign(window, {
    ...
    startEditJobComment: board.startEditJobComment,
    cancelEditJobComment: board.cancelEditJobComment,
    startReplyJobComment: board.startReplyJobComment,
    cancelReplyJobComment: board.cancelReplyJobComment,
